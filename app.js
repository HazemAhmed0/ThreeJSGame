...
import { LightningStorm } from 'https://cdn.skypack.dev/three@0.136/examples/jsm/objects/LightningStorm.js';
    ...
    class Boat{
        constructor(){
            ...
            loader.load("assets/New folder/scene.gltf", (gltf) => {
    ...
    class Island{
        constructor(){
            const loader = new GLTFLoader();
            loader.load("assets/New folder (2)/scene.gltf", (gltf) => {
    ...
    function init() {
        ...
        water = new Water(
            waterGeometry,
            {
                textureWidth: 512,
                textureHeight: 512,
                waterNormals: new THREE.TextureLoader().load( 'assets/water-pool-texture-blue-143546273.jpg', function ( texture ) {
